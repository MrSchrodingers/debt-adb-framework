import { Smartphone, Send, Users, Radio, BarChart3, FileText, X, AlertTriangle, Puzzle } from 'lucide-react'

type TabId = 'devices' | 'queue' | 'senders' | 'sessions' | 'metricas' | 'auditoria' | 'plugins'
